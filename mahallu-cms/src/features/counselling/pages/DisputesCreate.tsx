          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                {...register('type', { required: 'Please choose the dispute type.' })}
            ...
            <div>
              ...
              <textarea
                ...
                {...register('description', {
                  ...
                  maxLength: { value: 3000, message: 'Please keep the description to 3000 characters or less.' },
                })}
                  ...
                  <div key={field.id} className="flex gap-2">
                    <input
                      ...
                      {...register(`parties.${idx}.value`, {
                        maxLength: { value: 100, message: 'Please keep each name to 100 characters or less.' },
                      })}
                      type="text"
