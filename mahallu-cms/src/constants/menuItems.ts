...
export const menuItems: MenuItem[] = [
  ...
  {
    id: 'registrations-and-certificates',
    label: 'Registrations',
    icon: FiFileText,
    allowedRoles: ['super_admin', 'mahall'],
    children: [
      {
        id: 'registrations-submenu',
        label: 'Registration Types',
        icon: FiList,
        allowedRoles: ['super_admin', 'mahall'],
        children: [
          { id: 'nikah-reg', label: 'Nikah', icon: FiHeart, path: '/registrations/nikah', allowedRoles: ['super_admin', 'mahall'] },
          { id: 'death-reg', label: 'Death', icon: FiAlertCircle, path: '/registrations/death', allowedRoles: ['super_admin', 'mahall'] },
          { id: 'noc-reg', label: 'NOC', icon: FiFile, path: '/registrations/noc/common', allowedRoles: ['super_admin', 'mahall'] },
        ],
      },
      { id: 'certificates', label: 'Certificates', icon: FiFileText, path: '/admin/certificates', allowedRoles: ['super_admin', 'mahall'] },
      { id: 'change-requests', label: 'Change Requests', icon: FiClipboard, path: '/admin/change-requests', allowedRoles: ['super_admin', 'mahall'] },
    ],
  },
  {
    id: 'mahallu-finance',
  ...
  },
  {
    ...
    allowedRoles: ['super_admin', 'mahall'],
    children: [
      { id: 'data-quality', label: 'Data Quality', icon: FiBarChart2, path: '/admin/data-quality', allowedRoles: ['super_admin', 'mahall'] },
    ],
  },
];
